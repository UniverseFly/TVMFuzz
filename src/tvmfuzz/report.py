...
if __TVM_INSTRUMENTED__:
    assert os.getenv('NO_COV') is None, "Since you want coverage disabled, why linking an instrumented TVM?"
...
class Reporter:
    def __init__(self, report_folder=None, use_coverage=True, record_tir=False) -> None:
        # Checks
